...
```{r}
p_val_comp <- prop_df %>%
    select(class, prop_parent_161, prop_all_161) %>%
    dplyr::rename(condition=class,
                  c("treekoR - Proportion to Parent"= "prop_parent_161",
                    "treekoR - Proportion to All"= "prop_all_161")) %>%
...
prop_df %>%
    ...
    facet_wrap(~factor(prop_name,levels=c("treekoR - Proportion to All", 
                                          "De Biasi et al.", 
                                          "treekoR - Proportion to Parent")), scales="free", ncol=2) +
    gg_theme +
